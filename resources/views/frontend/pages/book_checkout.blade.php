        ...
        <div class="modal-card border-0">
           ...
           @endphp
            ...
            @if (session()->get('discount_amount_bn'))
                @php
                    $total = $book->price_bn + $shipping_charge - session()->get('discount_amount_bn');
                @endphp
            @else
                @php
                    $total = $book->price_bn + $shipping_charge;
                @endphp
            @endif
            <div class="gap-40 flex-lg-row">
                ...
                <form action="{{ route('book-order.store') }}" method="POST">
                    ...
                    <input type="hidden" name="price_bn" value="{{ $book->price_bn }}">

                    <div class="billing-details gap-32 padding-40 card">
                        <div class="d-flex justify-content-between">
                            <h5>ইবুক  অর্ডার সংক্রান্ত তথ্য</h5>
                    ...
                    <div class="gap-32">
                        ...
                        <div class="gap-32 flex-row p-1 justify-content-between align-items-center">
                            <div class="gap-16 flex-row align-items-center">
                                ...
                                <p class="p-16">{{ $book->title_bn }}</p>
                            </div>

                            <p class="p-18 fw-medium">৳ {{ $book->price_bn }}</p>
                        </div>
