          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                <h4>Why Study With Us  Update
                  <a href="{{route('admin.why-studyus.index')}}" class="btn btn-primary btn-sm" style="float:right;">Back</a>
                </h4>
              </div>

              <div class="card-body">
                <form action="{{route('admin.why-studyus.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="title_bn" value="{{ $data->title_bn }}" class="form-control" required>
                  </div>

                  <div class="form-group">
                    <label>Description English <span class="text-danger">*</span> </label>
                    <textarea name="description_en"  class="form-control" required rows="5">{{ $data->description_en }}</textarea>
                  </div>

                  <div class="form-group">
                    <label>Description Bangla <span class="text-danger">*</span> </label>
                    <textarea name="description_bn"  class="form-control" required rows="5">{{ $data->description_bn }}</textarea>
                  </div>
