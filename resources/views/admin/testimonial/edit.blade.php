              ...
              <div class="card-body">
                <form action="{{route('admin.testimonial.update',$testimonial->id)}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="country_en" value="{{ $testimonial->country_en }}"  class="form-control" required>
                  </div>

                  <div class="form-group">
                    <label>Country Bangla<span class="text-danger">*</span> </label>
                    <input type="text" name="country_bn" value="{{ $testimonial->country_bn }}"   class="form-control" required>
                  </div>
