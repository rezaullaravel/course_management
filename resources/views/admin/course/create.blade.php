            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.course-post.store') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="teacher_id" class="form-control">
                                        ...
                                        @foreach ($instructors as $row)
                                            <option value="{{ $row->id }}">{{ $row->name }}||{{ $row->email }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('teacher_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="topic11_en" class="form-control" placeholder="Enter topic eleven english">
                                    @error('topic11_en')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="topic11_bn" class="form-control" placeholder="Enter topic eleven bangla">
                                    @error('topic11_bn')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="topic12_en" class="form-control" placeholder="Enter topic twelve english">
                                    @error('topic12_en')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="topic12_bn" class="form-control" placeholder="Enter topic twelve bangla">
                                    @error('topic12_bn')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="topic13_en" class="form-control" placeholder="Enter topic thirteen english">
                                    @error('topic13_en')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="topic13_bn" class="form-control" placeholder="Enter topic thirteen bangla">
                                    @error('topic13_bn')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="topic14_en" class="form-control" placeholder="Enter topic fourteen english">
                                    @error('topic14_en')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="topic14_bn" class="form-control" placeholder="Enter topic fourteen bangla">
                                    @error('topic14_bn')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="topic15_en" class="form-control" placeholder="Enter topic fifteen english">
                                    @error('topic15_en')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="topic15_bn" class="form-control" placeholder="Enter topic fifteen bangla">
                                    @error('topic15_bn')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
